...
$CFG = new stdClass();
//$CFG->opensslcnf = 'C:Bitnamiwampstack-5.4.40-0phpextrasopenssl.conf';
...
$CFG->dbname    = 'Sql973959_3';     // database name, eg moodle
$CFG->dbuser    = 'admin';   // your database username
$CFG->dbpass    = 'Pippo123?';   // your database password
...
//$CFG->wwwroot   = 'http://woteach3.westeurope.cloudapp.azure.com/lms';
//$CFG->wwwroot   = 'http://woteach3.westeurope.cloudapp.azure.com/lms';
$CFG->wwwroot   = 'http://13.94.150.149/lms';
//$CFG->opensslcnf = 'C:Bitnamiwampstack-5.4.40-0phpextrasopenssl.conf';
...
$CFG->dataroot  = 'C:\xampp\htdocs\mt_moodledata';
