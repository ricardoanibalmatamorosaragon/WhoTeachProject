...
while(list($chiave,$valore)=each($array_category))
	...
	if ($valore=='Entrepreneurial Vision') {
		...
		if ($valore=='Personal Development') {
				$result = mysqli_query(GetMyConnection(), "SELECT property_value FROM Sql973959_3.mdl_metadata_descr where category='Personal Development' and (property_name='d_acq_skill' or property_name='s_acq_skill')" );
							while ($row = mysqli_fetch_row($result)){
							if (in_array($row[0], $array_metadati['d_acq_skill']) or in_array($row[0], $array_metadati['s_acq_skill'])) {
							echo '<option value="'.$row[0].'" selected="selected">'.$row[0].'</option>';
							}
		...
		if ($valore=='Communication Skills') {
				$result = mysqli_query( GetMyConnection(), "SELECT property_value FROM Sql973959_3.mdl_metadata_descr where category='Communication Skills' and (property_name='d_acq_skill' or property_name='s_acq_skill')" );
							while ($row = mysqli_fetch_row($result)){
							if (in_array($row[0], $array_metadati['d_acq_skill']) or in_array($row[0], $array_metadati['s_acq_skill'])) {
							echo '<option value="'.$row[0].'" selected="selected">'.$row[0].'</option>';
							}
		...
		if ($valore=='Economic Skills') {
				$result = mysqli_query(GetMyConnection(), "SELECT property_value FROM Sql973959_3.mdl_metadata_descr where category='Economic Skills' and (property_name='d_acq_skill' or property_name='s_acq_skill')" );
							while ($row = mysqli_fetch_row($result)){
							if (in_array($row[0], $array_metadati['d_acq_skill']) or in_array($row[0], $array_metadati['s_acq_skill'])) {
							echo '<option value="'.$row[0].'" selected="selected">'.$row[0].'</option>';
							}
		...
		if ($valore=='Technical Skills') {
				$result = mysqli_query(GetMyConnection(), "SELECT property_value FROM Sql973959_3.mdl_metadata_descr where category='Technical Skills' and (property_name='d_acq_skill' or property_name='s_acq_skill')");
							while ($row = mysqli_fetch_row($result)){
							if (in_array($row[0], $array_metadati['d_acq_skill']) or in_array($row[0], $array_metadati['s_acq_skill'])) {
							echo '<option value="'.$row[0].'" selected="selected">'.$row[0].'</option>';
							}
		...
		if ($valore=='Abilità Informatiche') {
				$result = mysqli_query(GetMyConnection(), "SELECT property_value FROM Sql973959_3.mdl_metadata_descr where category='Abilità Informatiche'");
							while ($row = mysqli_fetch_row($result)){
							if (in_array($row[0], $array_metadati['d_acq_skill']) or in_array($row[0], $array_metadati['s_acq_skill'])) {
							echo '<option value="'.$row[0].'" selected="selected">'.$row[0].'</option>';
							}
